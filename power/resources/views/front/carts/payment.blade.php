	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-10">
				...
				<form action="{{ route('cart.payment.checkout') }}" method="POST">
					@csrf
					<div class="box">
						<h3>Payment options</h3>					
						<label class="rdio">
							One Time
							<input type="radio" checked="checked" name="method" value="onetime">
					...
					<button type="submit" class="cart_pg_btn checkout_btn">confirm order</button>
				</form>
			</div>
		</div>
	</div>
